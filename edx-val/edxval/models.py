...
class VideoImage(TimeStampedModel):
    ...
    def __str__(self):
        ...
        """
        return '{} {}'.format(self.id, self.course_video.id)
...
class VideoTranscript(TimeStampedModel):
    ...
    def __str__(self):
        return '{} Transcript for {}'.format(self.language_code, self.video.edx_video_id)
...
class TranscriptPreference(TimeStampedModel):
    ...
    def __str__(self):
        return '{} - {}'.format(self.course_id, self.provider)
