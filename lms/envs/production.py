...
if LRS_MONGO_HOST:
    ...
    LRS_INTEGRATIONS_MONGO_DB = LRS_MONGO_CLIENT[AUTH_TOKENS.get('LRS_INTEGRATIONS_MONGO_DB', 'integrations')]
    LRS_INTEGRATIONS_MONGO_COLLECTION = AUTH_TOKENS.get('LRS_INTEGRATIONS_MONGO_COLLECTION', 'student_activity')
    LRS_IMPLEMENTATION_VERSION = AUTH_TOKENS.get('LRS_IMPLEMENTATION_VERSION', 'v1')
else:
    LRS_MONGO_CLIENT = None
    LRS_MONGO_DB = None
    LRS_INTEGRATIONS_MONGO_DB = None
    LRS_IMPLEMENTATION_VERSION = None
    LRS_INTEGRATIONS_MONGO_COLLECTION = None
