...
BROKER_TRANSPORT = AUTH_TOKENS.get('CELERY_BROKER_TRANSPORT')
BROKER_TRANSPORT_OPTIONS = AUTH_TOKENS.get('CELERY_TRANSPORT_OPTIONS', {
    'region': 'eu-west-1',
})
BROKER_HOST = AUTH_TOKENS.get('CELERY_BROKER_HOSTNAME')
...
for store in MODULESTORE['default']['OPTIONS']['stores']:
    store['DOC_STORE_CONFIG'].update(CONTENTSTORE['DOC_STORE_CONFIG'])
...
SENTRY_DSN = AUTH_TOKENS.get('SENTRY_DSN')

if SENTRY_DSN:
    sentry_sdk.init(dsn=SENTRY_DSN, integrations=[DjangoIntegration()])

# CodeInstitute
LMS_CRM_STUDENT_ELIGIBILITY_FIELD = AUTH_TOKENS.get('LMS_CRM_STUDENT_ELIGIBILITY_FIELD', 'Credit_Rating_Body')
LMS_CRM_STUDENT_ELIGIBILITY_FIELD_VALUES = AUTH_TOKENS.get('LMS_CRM_STUDENT_ELIGIBILITY_FIELD_VALUES')
HUBSPOT_CONTACTS_ENDPOINT = AUTH_TOKENS.get('HUBSPOT_CONTACTS_ENDPOINT')
HUBSPOT_API_KEY = AUTH_TOKENS.get('HUBSPOT_API_KEY')

LP_ZOHO_CLIENT_ID = AUTH_TOKENS.get('LP_ZOHO_CLIENT_ID')
LP_ZOHO_CLIENT_SECRET = AUTH_TOKENS.get('LP_ZOHO_CLIENT_SECRET')
LP_ZOHO_REFRESH_TOKEN = AUTH_TOKENS.get('LP_ZOHO_REFRESH_TOKEN')
LP_ZOHO_CHALLENGE_ENDPOINT = AUTH_TOKENS.get('LP_ZOHO_CHALLENGE_ENDPOINT')

ZOHO_CLIENT_ID = AUTH_TOKENS.get('ZOHO_CLIENT_ID')
ZOHO_CLIENT_SECRET = AUTH_TOKENS.get('ZOHO_CLIENT_SECRET')
ZOHO_REFRESH_TOKEN = AUTH_TOKENS.get('ZOHO_REFRESH_TOKEN')
ZOHO_REFRESH_RETRIES = AUTH_TOKENS.get('ZOHO_REFRESH_RETRIES')
ZOHO_REFRESH_SLEEP_SECS = AUTH_TOKENS.get('ZOHO_REFRESH_SLEEP_SECS')
ZOHO_REFRESH_ENDPOINT = AUTH_TOKENS.get('ZOHO_REFRESH_ENDPOINT')
ZOHO_STUDENTS_ENDPOINT = AUTH_TOKENS.get('ZOHO_STUDENTS_ENDPOINT')
ZOHO_MENTORS_ENDPOINT = AUTH_TOKENS.get('ZOHO_MENTORS_ENDPOINT')
ZOHO_TIMEOUT_SECONDS = AUTH_TOKENS.get('ZOHO_TIMEOUT_SECONDS', 0.5)
ZOHO_COQL_ENDPOINT = AUTH_TOKENS.get('ZOHO_COQL_ENDPOINT')

ZAPIER_STUDENT_CARE_EMAIL_ENDPOINT = AUTH_TOKENS.get('ZAPIER_STUDENT_CARE_EMAIL_ENDPOINT')

RDS_DB_USER = AUTH_TOKENS.get('RDS_DB_USER')
RDS_DB_PASS = AUTH_TOKENS.get('RDS_DB_PASS')
RDS_DB_ENDPOINT = AUTH_TOKENS.get('RDS_DB_ENDPOINT')
RDS_DB_PORT = AUTH_TOKENS.get('RDS_DB_PORT')
RDS_LMS_DB = AUTH_TOKENS.get('RDS_LMS_DB')

LMS_ACTIVITY_TABLE = AUTH_TOKENS.get('LMS_ACTIVITY_TABLE')
BREADCRUMBS_TABLE = AUTH_TOKENS.get('BREADCRUMBS_TABLE')
...
### MONGO DATABASE
LRS_MONGO_HOST = AUTH_TOKENS.get('LRS_MONGO_HOST', None)
if LRS_MONGO_HOST:
    ...
    LRS_STUDENT_ACTIVITY_COLLECTION = AUTH_TOKENS.get('LRS_STUDENT_ACTIVITY_COLLECTION', 'student_activity')
    LRS_LATEST_STUDENT_ACTIVITY_COLLECTION = AUTH_TOKENS.get('LRS_LATEST_STUDENT_ACTIVITY_COLLECTION', 'latest_student_activity')
    LRS_IMPLEMENTATION_VERSION = AUTH_TOKENS.get('LRS_IMPLEMENTATION_VERSION', 'lrs_call_lambda')
else:
    LRS_MONGO_CLIENT = None
    LRS_MONGO_DB = None
    LRS_STUDENT_ACTIVITY_COLLECTION = None
    LRS_LATEST_STUDENT_ACTIVITY_COLLECTION = None
    LRS_IMPLEMENTATION_VERSION = None

ENABLE_LATEST_ACTIVITY = AUTH_TOKENS.get('ENABLE_LATEST_ACTIVITY')
...
MODULE_EXPORTIMPORT_S3_ACCESS_KEY = AUTH_TOKENS.get('MODULE_EXPORTIMPORT_S3_ACCESS_KEY')
MODULE_EXPORTIMPORT_S3_SECRET_KEY = AUTH_TOKENS.get('MODULE_EXPORTIMPORT_S3_SECRET_KEY')

MODULE_EXPORTIMPORT_S3_BUCKET = AUTH_TOKENS.get('MODULE_EXPORTIMPORT_S3_BUCKET')
MODULE_EXPORTIMPORT_S3_FOLDER = AUTH_TOKENS.get('MODULE_EXPORTIMPORT_S3_FOLDER')
