...
LRS_QUEUE = os.environ.get('LRS_QUEUE', 'edx.lms.core.default')
DEFAULT_LMS_QUEUE = os.environ.get('DEFAULT_LMS_QUEUE', 'edx.lms.core.default')
...
### AMOS DATABASE ###
AMOS_USER = os.environ.get('AMOS_USER')
...
ZOHO_TIMEOUT_SECONDS = os.environ.get('ZOHO_TIMEOUT_SECONDS', 0.5)
ZOHO_COQL_ENDPOINT = os.environ.get('ZOHO_COQL_ENDPOINT')

LMS_CRM_STUDENT_ELIGIBILITY_FIELD = os.environ.get('LMS_CRM_STUDENT_ELIGIBILITY_FIELD', 'Credit_Rating_Body')
LMS_CRM_STUDENT_ELIGIBILITY_FIELD_VALUES = os.environ.get('LMS_CRM_STUDENT_ELIGIBILITY_FIELD_VALUES')
