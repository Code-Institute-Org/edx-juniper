...
CELERY_BROKER_USER = ENV_TOKENS.get('CELERY_BROKER_USER')
CELERY_BROKER_PASSWORD = ENV_TOKENS.get('CELERY_BROKER_PASSWORD')
CELERY_CREATE_MISSING_QUEUES = ENV_TOKENS.get('CELERY_CREATE_MISSING_QUEUES', False)
CELERY_DEFAULT_QUEUE = ENV_TOKENS.get('CELERY_DEFAULT_QUEUE')
CELERY_QUEUES = {queue: {} for queue in ENV_TOKENS.get('CELERY_QUEUES', [])}
...
BROKER_HOST = ENV_TOKENS.get('CELERY_BROKER_HOSTNAME')
BROKER_USER = ENV_TOKENS.get('CELERY_BROKER_USER')
BROKER_PASSWORD = ENV_TOKENS.get('CELERY_BROKER_PASSWORD')
...
MODULE_EXPORTIMPORT_S3_ACCESS_KEY = ENV_TOKENS.get('MODULE_EXPORTIMPORT_S3_ACCESS_KEY')
MODULE_EXPORTIMPORT_S3_SECRET_KEY = ENV_TOKENS.get('MODULE_EXPORTIMPORT_S3_SECRET_KEY')
MODULE_EXPORTIMPORT_S3_BUCKET = ENV_TOKENS.get('MODULE_EXPORTIMPORT_S3_BUCKET')
MODULE_EXPORTIMPORT_S3_FOLDER = ENV_TOKENS.get('MODULE_EXPORTIMPORT_S3_FOLDER')
MODULE_EXPORTIMPORT_ENDPOINT_URL = ENV_TOKENS.get('MODULE_EXPORTIMPORT_ENDPOINT_URL')
