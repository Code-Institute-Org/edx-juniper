...
CELERY_BROKER_PASSWORD = os.envion.get('CELERY_BROKER_PASSWORD')
CELERY_QUEUES = os.environ.get('CELERY_QUEUES', [])
CELERY_CREATE_MISSING_QUEUES = os.environ.get('CELERY_CREATE_MISSING_QUEUES')
